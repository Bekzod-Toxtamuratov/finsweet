			...
			<div class="container">
				<div class="max-md:flex-col md:flex gap-x-8">
					<div class="">
						...
						<p
							class="max-md:max-w-[380px] max-md:text-center max-md:mx-auto max-w-[460px] font-medium text-[16px] leading-7 text-[white]"
						>
						...
						>
							<router-link to="contact"
								><button
									class="max-md:ml-4 rounded-3xl sm:font-medium border border-white-500 px-2 py-[6px] sm:py-3 sm:px-8 md:py-4 md:px-16 bg-[#FCD980]"
								>
									View our work
								</button></router-link
							>
