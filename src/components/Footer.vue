...
<template>
  <div class="bg-[#1C1E53]">
    <div class="container">
      <div
        class="md:grid grid-cols-2 pt-[30px] pb-[50px] md:py-[100px] gap-x-[50px] items-center"
      >
        <div class="pt-5">
          <img src="/images/Logo.png" />
          <p class="max-w-[380px] mt-4 text-[white]">
            We are always open to discuss your project and improve your online
            presence
          </p>
          <div
            class="pl-[25px] md:flex gap-x-4 text-[#282938] bg-[#FCD980] py-3 w-full md:py-6 md:w-[80%] mt-[30px] md:mt-[86px] overflow-hidden"
          >
            <div class="">
              <p class="text-[14px] md:text-[18px] font-bold">Email me at</p>
              <p>bekzodtoxtamuratov@mgail.com</p>
            </div>
